  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="/1582819.png" class="h-8" alt="Flowbite Logo" />
      </a>
      <button
        v-on:click="showMenu"
      ...
      >
        ...
        <svg
          v-if="clickNav"
          class="w-6 h-6 animate-buttonHamburguer text-gray-800 dark:text-white transition-all duration-500 ease-in"
          aria-hidden="true"
        ...
        <svg
          v-else
          class="w-6 animate-buttonHamburguer h-6 text-gray-800 dark:text-white transition-all duration-500 ease-in"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
